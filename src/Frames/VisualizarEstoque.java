 ...
 * @author Gabriel
 */
public class VisualizarEstoque extends javax.swing.JFrame {
    ...
    public VisualizarEstoque(Estoque e) {
        parent = new ControleEstoque();
        initComponents();
        out = new JFrame();
        this.estoque = e;
    ...
    public void attTabela(){
        ArrayList<Produto> productList = estoque.getProdutos();
        TableModel tableModel = tableEstoque.getModel();
        int linha = 0;
        for (Produto produto : productList) {
            System.out.println(linha);
            tableModel.setValueAt(produto.getNome(), linha, 0);
            tableModel.setValueAt(produto.getPreco(), linha, 2);
            tableModel.setValueAt(produto.getQuantidadeEmEstoque(), linha, 1);
            linha++;
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ESTOQUE DE PRODUTOS - VIZUALIZAR");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addComponent(btnCancell, javax.swing.GroupLayout.PREFERRED_SIZE, 342, javax.swing.GroupLayout.PREFERRED_SIZE)
